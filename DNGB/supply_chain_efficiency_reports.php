...
$query = "
    SELECT 
        ...
        DATEDIFF(purchase_order.delivery_date, purchase_order.order_date) AS days_to_deliver,
...
<head>
    ...
    <title>Supply Chain Efficiency Report</title>
    <!-- Bootstrap CSS -->
