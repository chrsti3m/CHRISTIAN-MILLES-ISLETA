...
// Check if the user is logged in and has the Tricycle Operator role
if (!isset($_SESSION['user_id']) || $_SESSION['role'] !== 'Tricycle Operator') {
    header("Location: login.html"); // Redirect to login if not authorized
    exit();
}

// Fetch user details including profile picture and tricycle location
$stmt = $pdo->prepare("SELECT location FROM tricycle WHERE user_id = ?");
$stmt->execute([$_SESSION['user_id']]);
$tricycle = $stmt->fetch(PDO::FETCH_ASSOC);

$stmt = $pdo->prepare("SELECT name, contact_info, profile_picture, password FROM user WHERE user_id = ?");
$stmt->execute([$_SESSION['user_id']]);
...
<head>
    ...
    <title>Tricycle Operator Profile</title>
    <!-- Bootstrap CSS -->
...
<body>
    ...
    <div class="profile-container">
        ...
        <div class="profile-details">
            ...
            <form action="profiletricycle.php" method="POST" enctype="multipart/form-data" class="upload-form">
                <div class="mb-3">
            ...
            <table class="table table-bordered mt-4">
                ...
                <tr>
                    <th>Location</th>
                    <td><?php echo htmlspecialchars($tricycle['location']); ?></td>
                </tr>
            </table>
        </div>
        ...
        <div class="password-form">
            ...
            <form action="profiletricycle.php" method="POST">
                <div class="mb-3">
